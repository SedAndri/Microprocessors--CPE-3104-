...
ORG 00250H
   ...
   MODE_FLAG DB 1
   TEMP DB ?
   SCROLL_POS DW 0          ; current horizontal start offset into message column stream
DATA ENDS
...
START:
   ...
   ; Mode 1
   DEFAULT:
      ; SI = start of 8-column window
      MOV SI, OFFSET MSG_BORDARIO
      MOV AX, SCROLL_POS
      ADD SI, AX
      CALL PRINT_CHAR        ; treat 8 bytes as one "frame" (PRINT_CHAR will scan 8 columns)
      ; advance scroll position
      INC SCROLL_POS
      MOV AX, SCROLL_POS
      CMP AX, 57             ; last valid start offset = total_len(64) - window(8) = 56
      JL CONT_SCROLL
      MOV SCROLL_POS, 0
   CONT_SCROLL:
   JMP HERE
...
; 5x7 uppercase glyphs for B O R D A R I O (LSB..bit4 used as 5 columns)
CH_B:
      DB 00011110B
      DB 00010001B
      DB 00010001B
...
; Concatenated column stream for scrolling "BORDARIO"
; Each letter = 7 columns + 1 blank spacer column
MSG_BORDARIO:
; B
      DB 00011110B,00010001B,00010001B,00011110B,00010001B,00010001B,00011110B,00000000B
; O
      DB 00001110B,00010001B,00010001B,00010001B,00010001B,00010001B,00001110B,00000000B
; R
      DB 00011110B,00010001B,00010001B,00011110B,00010010B,00010001B,00010001B,00000000B
; D
      DB 00011110B,00010001B,00010001B,00010001B,00010001B,00010001B,00011110B,00000000B
; A
      DB 00001110B,00010001B,00010001B,00011111B,00010001B,00010001B,00010001B,00000000B
; R
      DB 00011110B,00010001B,00010001B,00011110B,00010010B,00010001B,00010001B,00000000B
; I
      DB 00011111B,00000100B,00000100B,00000100B,00000100B,00000100B,00011111B,00000000B
; O
      DB 00001110B,00010001B,00010001B,00010001B,00010001B,00010001B,00001110B,00000000B
