...
DELAY_1MS:
    ; Calibrated for 8086 @ 1 MHz.
    ; From just before CALL to just after RET ˜ 1.006 ms.
    ; Cycles per iteration: NOP(3T) + LOOP taken(17T), final not-taken(5T)
    ; Total per call ˜ CALL(19) + PUSH CX(11) + MOV CX,imm(4) + (20*N - 12)
    ;                  + POP CX(8) + RET(16) = 20*N + 46 T
    ; N=48 => 20*48+46 = 1006 T ˜ 1.006 ms
    PUSH CX
    MOV  CX, 30H          ; 48 iterations
DLY1:
    NOP
    LOOP DLY1
    POP  CX
